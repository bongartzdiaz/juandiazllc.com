...
export async function PATCH(req: NextRequest, ctx: Ctx) {
  ...
  const limited = enforceRateLimit(`showings.update:${scope.userId}`, PRESET_MUTATION)
...
export async function DELETE(_req: NextRequest, ctx: Ctx) {
  ...
  const limited = enforceRateLimit(`showings.delete:${scope.userId}`, PRESET_MUTATION)
  if (limited) return limited
