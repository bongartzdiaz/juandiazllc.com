...
export async function PATCH(req: NextRequest, ctx: RouteCtx) {
  ...
  const limited = enforceRateLimit(`reservations.update:${scope.userId}`, PRESET_MUTATION)
...
export async function DELETE(_req: NextRequest, ctx: RouteCtx) {
  ...
  const limited = enforceRateLimit(`reservations.delete:${scope.userId}`, PRESET_MUTATION)
  if (limited) return limited
