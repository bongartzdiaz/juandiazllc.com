...
export async function PATCH(req: NextRequest, ctx: Ctx) {
  ...
  const limited = enforceRateLimit(`e-signatures.update:${scope.userId}`, PRESET_MUTATION)
...
export async function DELETE(_req: NextRequest, ctx: Ctx) {
  ...
  const limited = enforceRateLimit(`e-signatures.delete:${scope.userId}`, PRESET_MUTATION)
  if (limited) return limited
