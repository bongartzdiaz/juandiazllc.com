...
export async function PATCH(req: NextRequest, ctx: RouteCtx) {
  ...
  const limited = enforceRateLimit(`projects.update:${scope.userId}`, PRESET_MUTATION)
...
export async function DELETE(_req: NextRequest, ctx: RouteCtx) {
  ...
  const limited = enforceRateLimit(`projects.delete:${scope.userId}`, PRESET_MUTATION)
  if (limited) return limited
