      ...
      {!c ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            {c.source && (
              <span style={{ fontSize: 11.5, color: 'var(--txt3)' }}>via {c.source}</span>
            )}
            <span style={{ flex: 1 }} />
          ...
          <div style={{
            ...
            <Field icon={Tag} label="Type" value={c.type} capitalize />
          </div>
          ...
          {(c.aiIndustry || c.aiSummary || c.aiIcpFit != null) && (
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 600 }}>AI Intelligence</span>
                <span
                  className="mono"
                  title="Generated by Anthropic Claude Haiku from data already on this contact. Decision-support only."
                  style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 80px', gap: 14, alignItems: 'flex-start' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {c.aiIndustry && (
                    <div>
                      <div style={{ fontSize: 10.5, color: 'var(--txt3)', marginBottom: 2 }}>Industry</div>
          ...
          {c.contactProjects.length > 0 && (
            <div>
              <div style={{ fontSize: 11, color: 'var(--txt3)', marginBottom: 6 }}>
                Linked ({c.contactProjects.length})
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                ...
                {c.contactProjects.length > 4 && (
                  <div style={{ fontSize: 11, color: 'var(--txt3)', paddingLeft: 8 }}>
                    +{c.contactProjects.length - 4} more
                  </div>
                )}
              </div>
            </div>
