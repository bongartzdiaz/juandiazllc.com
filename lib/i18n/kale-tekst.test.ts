...
const TOEGESTAAN: Record<string, { reden: string; tekst: string[] }> = {
  ...
  "app/[locale]/tools/lekkage-scan/page.tsx": {
    ...
    tekst: [
      ...
      "De omzet lekt zelden in de markt. Hij lekt tussen de tools — in de overdracht naar de buitendienst, in de dagen tussen aanvraag en offerte, in het adres dat voor de derde keer wordt overgetypt. Vijftien vragen, en je weet welke drie bij jou het eerst lekken.",
    ],
  },
  "components/LekkageScan.tsx": {
    ...
    tekst: [
      ...
      "Dat is een echte uitkomst en geen beleefdheid. Vijftien ja/nee-vragen vinden de lekken die met overdracht, wachttijd, dubbele invoer en overlappende tools te maken hebben. Zitten die goed, dan zit je probleem ergens anders.",
      "van de",
      "vragen onder",
      ...
      "Geen marge per project, geen kwaliteit van de instroom, geen bezetting, en niets over of je mensen een nieuw systeem zouden gebruiken. Vijftien ja/nee-vragen dragen hun eigen reikwijdte, en dit is hem.",
      "Wil je dit nagelopen hebben op je eigen cijfers in plaats van op vijftien vragen? Dat is het blueprint-gesprek: dertig minuten, en er komt een diagnose van één pagina uit.",
    ],
  },
  "components/ScanCallout.tsx": {
    ...
    tekst: [
      "◉ Vier minuten",
      "Vijftien ja/nee-vragen over je stack, en je ziet welke drie dingen bij jou het eerst lekken. Geen e-mail, geen verkooppraat — de uitslag staat meteen op je scherm.",
      "Doe de lekkage-scan",
    ],
  },
