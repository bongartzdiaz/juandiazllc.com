...
export const POSTS: Insight[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "h2", text: "Wat ik hier niet beweer" },
      { type: "p", text: "Ik noem geen indieningsdatum en geen sanctie. Die heb ik niet nagetrokken, en een datum uit het hoofd citeren is in dit dossier precies de fout die je wilt vermijden. De RVO publiceert beide; controleer ze daar voordat je iets in een agenda zet." },
      { type: "p", text: "Wat ik wel beweer is smal en toetsbaar. De verplichting geldt vandaag, het toezicht kijkt naar datakwaliteit, en de vier bronnen waaruit je cijfer moet komen zijn niet gebouwd om samen een verslag op te leveren. Wie dat een keer goed regelt, is klaar voor de volgende versie van de regels in plaats van voor deze." },
    ],
  },
  {
