...
export const POSTS: Insight[] = [
...

  {
    ...
    markets: ["nl"],
    title: "Je deadline is 2030. Je meetlat verandert datzelfde jaar.",
    summary:
    ...
    seo: {
      ...
      metaDescription:
        "Label D uiterlijk 1-1-2030 voor de slechtste utiliteitsgebouwen. In hetzelfde jaar wijzigt de labelschaal. Hoe je dan toch een rangorde bouwt die standhoudt.",
    },
    body: [
      ...
      { type: "h2", text: "Wat er vaststaat, en het is minder dan je denkt" },
      ...
      { type: "p", text: "Lees die laatste zin nog een keer. De regels waaraan je in 2030 moet voldoen liggen pas in 2027 vast. Dat is drie jaar voorbereidingstijd voor een portefeuille waarin een enkele renovatie al snel twee jaar kost aan vergunning, aanbesteding en uitvoering." },
      ...
      { type: "p", text: "Dat is de kern van het probleem, en het wordt zelden zo benoemd. Je plant kapitaal tegen een getal dat in het jaar van je deadline opnieuw wordt gedefinieerd, met een andere rekenmethode eronder. Het label op je huidige rapportage en het label waarop je straks wordt afgerekend zijn niet hetzelfde instrument." },
      { type: "p", text: "Hoe die twee zich tot elkaar verhouden weet vandaag niemand precies, en wie beweert van wel verkoopt je iets. Wat je wel kunt doen is zorgen dat je de vertaalslag straks in een week maakt in plaats van in een kwartaal." },

      { type: "h2", text: "De rangorde die je nodig hebt bestaat nog niet" },
      { type: "p", text: "Om te weten welk pand eerst moet, heb je per object een betrouwbaar verbruikscijfer nodig. In de praktijk staat dat verspreid over vier of vijf plekken die elkaar tegenspreken:" },
      { type: "ul", items: [
      ...
      { type: "p", text: "Het is ook geen voorspelling over wat er in 2027 in het Bbl komt te staan. Dat weet ik niet en je ook niet. De hele redenering hierboven gaat er juist van uit dat de eisen nog schuiven, en dat is geen risico dat je wegneemt maar een eigenschap waar je omheen bouwt." },
      { type: "p", text: "De vraag om mee te beginnen is klein genoeg om deze week te stellen. Kun je vandaag, zonder iemand te bellen, per gebouw laten zien waar het verbruikscijfer vandaan komt en wanneer het is gemeten? Als het antwoord nee is, dan is dat het eerste dat verandert. De deadline is 2030, maar het werk begint bij de herkomst van een getal." },
    ],
  },
  {
    slug: "ets2-de-gasrekening-krijgt-een-component-erbij",
    markets: ["nl"],
    title: "Je gasrekening krijgt een component erbij, en die zit niet in je begroting",
    summary:
      "ETS2 beprijst vanaf 2027 de CO2 in aardgas voor gebouwen. De verplichting ligt bij je leverancier, niet bij je, en dat maakt het lastiger in plaats van makkelijker: je ziet niet wanneer het in je tarief terechtkomt of hoeveel het is.",
    tag: "Real estate",
    publishedAt: "2026-08-23",
    readingMinutes: 5,
    seo: {
      metaTitle: "ETS2 en je gasrekening: wat er echt vaststaat",
      metaDescription:
        "ETS2 beprijst vanaf 2027 CO2 in gebouwgas. De verplichting ligt bij de leverancier. Wat vaststaat, wat gepland is, en waarom je tarief het pas later verraadt.",
    },
    body: [
      { type: "p", text: "Er is een tweede regelgevingsspoor dat gebouwen raakt, en het werkt heel anders dan het energielabel. Waar de labelverplichting een investeringsbeslissing afdwingt, verandert dit spoor stilletjes je exploitatie. Het heet ETS2 en het beprijst de CO2 die vrijkomt bij het gebruik van fossiele brandstoffen in de gebouwde omgeving en het wegvervoer." },
      ...
      { type: "h2", text: "De verplichting ligt niet bij je, en dat is het lastige deel" },
      { type: "p", text: "Je hoeft niets te doen. Geen vergunning, geen rapportage, geen registeraccount. De verplichting ligt formeel bij de partij die je de brandstof levert, en die koopt de rechten en verwerkt de kosten in het tarief." },
      { type: "p", text: "Dat klinkt als goed nieuws en het is het tegenovergestelde. Bij een heffing die je zelf afdraagt weet je de datum, het tarief en de grondslag. Bij een kostenpost die via een derde binnenkomt, weet je geen van drieën. Je ziet een tarief, en of daar CO2-kosten in zitten en hoeveel is niet af te lezen aan je factuur." },
      { type: "p", text: "Wanneer leveranciers het gaan doorberekenen is bovendien een commerciële beslissing, geen wettelijke. Sommige beginnen zodra ze rechten inkopen. Andere spreiden het uit. Weer andere hebben het al ingeprijsd in een contract dat je vorig jaar hebt getekend, zonder dat het als aparte regel zichtbaar is." },

      { type: "h2", text: "Waarom dit een meetprobleem is en geen inkoopprobleem" },
      { type: "p", text: "De gebruikelijke reactie is scherper inkopen: langer vastzetten, meer offertes, een adviseur op de tender. Dat helpt marginaal, maar het lost het onderliggende probleem niet op. Je kunt namelijk niet controleren of het aanbod dat je krijgt goed of slecht is, omdat je je eigen basislijn niet scherp hebt." },
      { type: "ul", items: [
        ...
        "welk deel belandt bij een huurder en welk deel blijft bij je hangen",
      ...
      { type: "p", text: "Deze twee sporen vragen om dezelfde onderliggende data. Voor de labelverplichting heb je per gebouw een betrouwbaar verbruikscijfer nodig om een rangorde te bouwen. Voor ETS2 heb je per gebouw een betrouwbaar gasverbruik nodig om een kostenstijging te kunnen toerekenen." },
      ...
      { type: "h2", text: "Wat ik hier niet beweer" },
      { type: "p", text: "Ik heb geen bedrag. Wat ETS2 per kubieke meter gaat kosten hangt af van een veilingprijs die nog niet bestaat en van hoe je leverancier hem doorberekent. Iedere partij die je nu een tabel met eurocijfers voorlegt, extrapoleert een aanname en presenteert hem als prognose." },
      { type: "p", text: "Wat wel vaststaat is de richting en de reden dat je het laat gaat zien. Het beleid is bedoeld om fossiel duurder te maken, de kosten komen via een derde binnen, en je factuur splitst het niet uit. Dat is voldoende om nu je basislijn op orde te brengen, en het is te weinig om nu een investering op te baseren." },
    ],
  },
  {
    slug: "kostprijs-per-kilometer-ets2-de-component-die-u-niet-ziet",
    markets: ["nl"],
    title: "Je kostprijs per kilometer krijgt een component die je niet ziet",
    summary:
    ...
    readingMinutes: 6,
    seo: {
      metaTitle: "ETS2 en je kostprijs per kilometer",
      metaDescription:
        "ETS2 legt de CO2-kosten van wegbrandstof bij je leverancier. Wat vaststaat, wat gepland is, en waarom je eigen basislijn belangrijker is dan de prognose.",
    },
    body: [
      { type: "p", text: "Vraag tien vervoerders naar hun kostprijs per kilometer en je krijgt tien getallen die met stelligheid worden gebracht. Vraag door naar de herkomst en het beeld kantelt. Het cijfer is meestal een optelsom uit drie systemen die elkaar niet kennen: de planning weet de ritten, de tankpas weet de liters, en het transportmanagementsysteem weet de opdrachten. Wie ze op elkaar legt houdt verschillen over die niemand kan verklaren." },
      { type: "p", text: "Zolang de brandstofprijs meebeweegt met de markt is dat te overleven. Je ziet de dieselprijs stijgen, je past je tarief aan, klaar. Vanaf 2027 komt er een component bij die niet op die manier zichtbaar is." },
      ...
      { type: "p", text: "Wie je vandaag een tabel voorlegt met eurocenten per liter, extrapoleert een aanname en noemt het een prognose. Er is geen veilingprijs, dus er is geen bedrag." },

      { type: "h2", text: "De verplichting ligt niet bij je, en dat is het lastige deel" },
      { type: "p", text: "Je hoeft niets te doen. Geen vergunning, geen registeraccount, geen rapportage. De verplichting ligt formeel bij de partij die je de brandstof levert. Die koopt de rechten in en verwerkt de kosten in het tarief." },
      { type: "p", text: "Dat klinkt comfortabel en het is het tegenovergestelde. Bij een heffing die je zelf afdraagt ken je de datum, het tarief en de grondslag. Bij een kostenpost die via een derde binnenkomt ken je geen van drieën. Je ziet een literprijs, en of daar CO2-kosten in zitten en hoeveel is er niet aan af te lezen." },
      { type: "p", text: "Wanneer leveranciers gaan doorberekenen is bovendien een commerciële beslissing en geen wettelijke. Sommige beginnen zodra ze rechten inkopen. Andere spreiden het. Weer andere hebben het al verwerkt in een contract dat vorig jaar is getekend, zonder aparte regel." },

      { type: "h2", text: "Waarom scherper inkopen dit niet oplost" },
      { type: "p", text: "De reflex is begrijpelijk: langer vastzetten, meer offertes, een adviseur op de aanbesteding. Dat helpt marginaal. Maar je kunt niet beoordelen of een aanbod goed of slecht is zolang je je eigen basislijn niet scherp hebt, en dat is precies wat er ontbreekt." },
      { type: "p", text: "Vier vragen bepalen of je een tariefstijging kunt toerekenen of er alleen over kunt discussiëren:" },
      { type: "ul", items: [
  ...
  },
  {
    ...
    markets: ["nl"],
    title: "Niet of je rapporteert wordt gecontroleerd, maar of je cijfers kloppen",
    summary:
    ...
    readingMinutes: 5,
    seo: {
      metaTitle: "WPM: het toezicht kijkt naar je datakwaliteit",
      metaDescription:
    ...
    body: [
      ...
      { type: "p", text: "Op zichzelf is dat een administratieve klus. Wat het interessanter maakt is het toezicht: een omgevingsdienst controleert of je organisatie het verslag verstuurt en de kwaliteit van je gegevens. Die tweede helft is waar dit van een formaliteit in een echt probleem verandert." },
      ...
      { type: "p", text: "Twee dingen volgen daaruit, en ze wijzen dezelfde kant op. Je kunt er niet op wachten, want vandaag geldt de grens van honderd. En je kunt er geen eenmalig project van maken, want de spelregels bewegen nog. Wat je bouwt moet volgend jaar opnieuw te draaien zijn met andere invoer." },
      ...
      { type: "p", text: "De aanpak die standhoudt bestaat uit vier dingen. Bepaal per gegevensbron wie hem beheert en hoe vaak hij ververst. Leg vast welke aannames je doet waar de data ontbreekt, in plaats van te middelen en de aanname te vergeten. Noteer bij elk cijfer de meetdatum. En zorg dat de hele bewerking herhaalbaar is, in code of in een beschreven processtap, zodat iemand anders hem volgend jaar kan draaien zonder je." },
      { type: "p", text: "Dat laatste punt is waar de meeste organisaties het laten liggen. Het verslag van vorig jaar is gemaakt door iemand die inmiddels iets anders doet, in een spreadsheet die niemand meer helemaal begrijpt. Dat werkt precies tot het moment dat er iemand langskomt die vraagt hoe je aan een getal komt." },
      { type: "cta", text: "Lees wat er verandert zodra je een tweede jaar hebt om mee te vergelijken", href: "/insights/wpm-jaar-twee-je-cijfer-wordt-vergeleken-met-je-eigen-cijfer" },

      { type: "h2", text: "Wat ik hier niet beweer" },
      { type: "p", text: "Ik noem geen sanctie. Die heb ik niet nagetrokken, en een gevolg uit het hoofd citeren is in dit dossier precies de fout die je wilt vermijden. De indieningsdatum stond hier eerder ook als niet nagetrokken; die is inmiddels wel nagetrokken en staat in het vervolgstuk hierboven." },
      { type: "p", text: "Wat ik wel beweer is smal en toetsbaar. De verplichting geldt vandaag, het toezicht kijkt of je cijfers geloofwaardig zijn, en de vier bronnen waaruit je cijfer moet komen zijn niet gebouwd om samen een verslag op te leveren. Wie dat een keer goed regelt, is klaar voor de volgende versie van de regels in plaats van voor deze." },    ],
  },
  {
    slug: "wpm-jaar-twee-je-cijfer-wordt-vergeleken-met-je-eigen-cijfer",
    markets: ["nl"],
    title: "Jaar twee: je cijfer wordt vergeleken met je eigen cijfer",
    summary:
    ...
    readingMinutes: 5,
    seo: {
      metaTitle: "WPM jaar twee: geloofwaardig is niet juist",
      metaDescription:
        "In 2026 rapporteer je over 2025 en 2024. Twee eigen cijfers naast elkaar, en een verschil ertussen heeft drie oorzaken. Weet je welke?",
    },
    body: [
      { type: "p", text: "De eerste WPM-rapportage was vooral een verzamelklus. Ergens in de organisatie stonden de gegevens, verspreid over systemen die nooit bedoeld waren om samen een verslag op te leveren, en het lukte. De tweede ronde is een ander soort werk, en dat verschil zit niet in het formulier." },
      { type: "p", text: "De RVO schrijft dat je in 2026 kunt rapporteren over 2025 en over 2024. Dat is de hele verandering. Voor het eerst kunnen twee van je eigen cijfers naast elkaar liggen, en vanaf dat moment is er iets om je getal mee te vergelijken." },
      { type: "h2", text: "Het woord in de regel is geloofwaardig" },
      { type: "p", text: "Het loont om te lezen wat de toezichthouder precies toetst, want dat is smaller dan de meeste mensen aannemen en het staat er in een zin." },
      ...
      { type: "p", text: "Juist is een eigenschap van een getal op zichzelf. Geloofwaardig is een eigenschap van een getal in verhouding tot iets anders: tot de omvang van je organisatie, tot wat vergelijkbare bedrijven aanleveren, en het meest voor de hand liggend tot wat je vorig jaar zelf hebt opgegeven. Een aannemelijkheidstoets heeft een referentie nodig, en in de eerste ronde was die er nauwelijks." },
      { type: "p", text: "Nu wel. Daarmee verschuift de vraag die je krijgt. Vorig jaar was het: waar komt dit getal vandaan. Dit jaar is het: waarom is dit getal anders dan het vorige." },
      { type: "h2", text: "Een verschil met vorig jaar heeft precies drie oorzaken" },
      { type: "p", text: "Elke verandering tussen twee rapportagejaren valt in een van drie categorieën, en ze zien er in de uitkomst identiek uit." },
      { type: "ul", items: [
      ...
      { type: "p", text: "Dezelfde daling kan uit alle drie komen. Het punt is niet welke van de drie is toegestaan, want dat zijn ze alle drie. Het punt is of je kunt zeggen welke het was." },
      { type: "p", text: "De organisatie die dat niet kan, houdt een antwoord over: zo kwam het eruit. Dat is precies het antwoord waarmee een aannemelijkheidstoets verandert in een gesprek dat je niet stuurt." },
      { type: "h2", text: "De toets is verklaarbaarheid, en dat zegt de uitvoerder er zelf bij" },
      { type: "p", text: "De RVO publiceert een handreiking en belooft daarbij iets specifieks: volg je die uitleg, dan kun je verklaren hoe je aan je gegevens bent gekomen, en normaal gesproken gaat de omgevingsdienst daarmee akkoord. Daar staat een zin achter die je moet meelezen." },
      { type: "quote", text: "Maar een garantie kunnen we niet geven.", cite: "RVO, veelgestelde vragen rapportage WPM" },
      { type: "p", text: "Wat de handreiking oplevert is dus geen goedkeuring vooraf. Het is het vermogen om je eigen cijfer uit te leggen, en de omgevingsdienst houdt zijn eigen oordeel. Wie mikt op een preciezer getal, mikt op het verkeerde doel. Wie mikt op een getal waarvan de herkomst is opgeschreven, mikt op het goede." },
      { type: "p", text: "In de praktijk is dat een regel per cijfer per jaar. Welke van de drie oorzaken is veranderd, en waarom. Het kost minuten op het moment dat je het opschrijft, en het is een jaar later je hele verweer." },
      { type: "h2", text: "Je verplichting wordt elk jaar opnieuw getoetst" },
      { type: "p", text: "Er is nog een verandering die van buiten komt. De RVO kijkt vanaf 2025 jaarlijks op 1 januari naar het aantal werknemers dat je in dienst hebt. Je verplichting wordt dus niet eenmalig vastgesteld maar elk jaar opnieuw." },
      { type: "p", text: "Voor een groeiend bedrijf is dat een dekkingsverandering die je niet zelf plant. Je groeit over de grens heen, en dan geldt de rapportageplicht. Voor iedereen die er al in zit, geldt dezelfde jaarlijkse ritmiek: uiterlijk 30 juni lever je aan over het voorgaande kalenderjaar." },
      { type: "p", text: "Die datum is scherper dan hij oogt. Het venster waarin je nog kunt uitzoeken waar een cijfer van vorig jaar vandaan kwam, is de eerste helft van het jaar. Daarna is iedereen die eraan meewerkte er weer een jaar verder vanaf." },
      { type: "cta", text: "Lees waarom die vier bronnen nooit samen een verslag opleveren", href: "/insights/wpm-de-omgevingsdienst-controleert-uw-cijfers-niet-uw-inzending" },
      { type: "h2", text: "Wat ik hier niet beweer" },
      { type: "p", text: "Ik zeg niets over wat de eerste landelijke rapportageronde heeft opgeleverd. Dat cijfer heb ik niet, en een uitspraak over hoe Nederlandse werkgevers het collectief hebben gedaan zou precies het soort getal zijn waar dit stuk tegen waarschuwt. Ik noem ook geen sanctie en geen gevolg van een afgekeurd verslag: niet nagetrokken, dus niet opgeschreven." },
      { type: "p", text: "Wat ik wel beweer is smal. Het toezicht kijkt of je gegevens geloofwaardig zijn en niet of ze tot achter de komma kloppen, in 2026 kunnen voor het eerst twee van je eigen jaren naast elkaar liggen, en een verschil daartussen heeft drie mogelijke oorzaken. Of je die oorzaak kunt benoemen, beslis je op het moment dat je het cijfer maakt. Niet op het moment dat iemand ernaar vraagt." },
    ],
  },
  {
