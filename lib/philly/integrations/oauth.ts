...
// Lazy resolve so Next.js's build-time "collect page data" pass (which
// evaluates every route module without the full production env) doesn't
// blow up when a secret is missing. Runtime callers still fail loudly.
