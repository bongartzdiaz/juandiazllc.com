...
export function initSentry(): void {
  ...
  try {
    mod.init({
      ...
      // Default-deny PII; layer on beforeSend to scrub auth headers,
      // query-string tokens, email-shaped strings, and known sensitive
      // keys inside extras. GDPR Art. 32 — minimize at the SDK edge.
