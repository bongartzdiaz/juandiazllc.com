...
const MOCK_KEYWORDS: GoogleKeyword[] = [
...
const MOCK_DAILY: GoogleDailyStats[] = [
  { date: '2026-03-01', label: '1/3', spend: 62, conversions: 3 },
  { date: '2026-03-02', label: '2/3', spend: 78, conversions: 5 },
  { date: '2026-03-03', label: '3/3', spend: 71, conversions: 4 },
  { date: '2026-03-04', label: '4/3', spend: 89, conversions: 6 },
  { date: '2026-03-05', label: '5/3', spend: 95, conversions: 7 },
  { date: '2026-03-06', label: '6/3', spend: 82, conversions: 5 },
  { date: '2026-03-07', label: '7/3', spend: 104, conversions: 9 },
  { date: '2026-03-08', label: '8/3', spend: 91, conversions: 7 },
  { date: '2026-03-09', label: '9/3', spend: 110, conversions: 10 },
  { date: '2026-03-10', label: '10/3', spend: 98, conversions: 8 },
  { date: '2026-03-11', label: '11/3', spend: 88, conversions: 6 },
  { date: '2026-03-12', label: '12/3', spend: 115, conversions: 11 },
  { date: '2026-03-13', label: '13/3', spend: 102, conversions: 9 },
  { date: '2026-03-14', label: '14/3', spend: 96, conversions: 8 },
]
...
export async function fetchGoogleAds(market: Market = 'NL'): Promise<GoogleAdsData> {
  try {
...
// Uses Google Ads REST API via the provided credentials.
...
export async function fetchFromGoogleApi(market: Market): Promise<GoogleAdsData | null> {
  ...
  // Step 2: Query campaigns via Google Ads REST API
  const query = `
