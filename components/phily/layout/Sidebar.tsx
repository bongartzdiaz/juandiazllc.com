...
export function Sidebar({ onNavigate }: { onNavigate?: () => void } = {}) {
  ...
  const NAV_PRIMARY: NavItemDef[] = [
    { icon: LayoutDashboard, label: 'Dashboard', href: '/diaz/dashboard' },
    { icon: FolderKanban, label: config.projectsLabel, href: '/diaz/dashboard/projects' },
    { icon: Users2, label: 'Contacts', href: '/diaz/dashboard/contacts' },
    { icon: BarChart3, label: industry === 'realestate' ? 'Market' : 'Impact', href: '/diaz/dashboard/impact' },
  ]

  const NAV_TOOLS: NavItemDef[] = [
    { icon: FileText, label: 'Reports', href: '/diaz/dashboard/reports' },
    { icon: Columns3, label: industry === 'realestate' ? 'Deals' : industry === 'hospitality' ? 'Reservations' : 'Board', href: '/diaz/dashboard/kanban' },
    { icon: CalendarDays, label: 'Calendar', href: '/diaz/dashboard/calendar' },
  ]

  const NAV_SYSTEM: NavItemDef[] = [
    { icon: Settings, label: 'Settings', href: '/diaz/dashboard/settings' },
  ]
