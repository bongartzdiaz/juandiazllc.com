...
import { useKpiStore } from '@/hooks/phily/useKpiStore'
import { useTheme } from '@/hooks/phily/useTheme'
import { useDashboardLayout } from '@/hooks/phily/useDashboardLayout'
import { CSR_WIDGETS, RE_WIDGETS, HOS_WIDGETS } from '@/lib/phily/dashboard-layout'
import type { WidgetId } from '@/lib/phily/dashboard-layout'
import { KpiDetailDrawer } from '@/components/phily/dashboard/KpiDetailDrawer'
import { AlertsCard } from '@/components/phily/dashboard/AlertsCard'
import { FunnelCard } from '@/components/phily/dashboard/FunnelCard'
import { GoalsCard } from '@/components/phily/dashboard/GoalsCard'
import { ForecastCard } from '@/components/phily/dashboard/ForecastCard'
import { LeadSourceCard } from '@/components/phily/dashboard/LeadSourceCard'
import { AddLeadModal } from '@/components/phily/dashboard/AddLeadModal'
import {
  JourneyBar,
  CSR_JOURNEY, CSR_SUMMARY,
  RE_SALES_JOURNEY, RE_RENTAL_JOURNEY, RE_SUMMARY,
  HOS_JOURNEY, HOS_SUMMARY,
} from '@/components/phily/dashboard/JourneyBar'
import type { JourneyPeriod } from '@/components/phily/dashboard/JourneyBar'
import {
