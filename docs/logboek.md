# Sessielogboek juandiazllc.com

Uit `CLAUDE.md` verhuisd op 2026-09-19 zodat het niet bij elke sessie in de
context wordt geladen. Chronologisch, oudste eerst; nieuwe blokken onderaan.
Logboekgeschiedenis wordt niet herschreven. Voor de levende stand (wat er niet
meer woont, operator-lijst) zie `CLAUDE.md`.
